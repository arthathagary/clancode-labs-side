...
const ServicesPage = () => {
  ...
  return (
    ...
    <div className='flex flex-col gap-4 justify-self-start'>
      <h4 id='sdBtn' className='bg-[#004450] px-6 py-4  font-bold text-[white] cursor-pointer hover:bg-white hover:text-[#004450]' onMouseOver={clickHandler}>Software Development</h4>
      <h4 id='uiBtn' className='bg-[#004450] px-6 py-4  font-bold text-[white] cursor-pointer hover:bg-white hover:text-[#004450]' onMouseOver={clickHandler}>UI/UX Design</h4>
      <h4 id='mdBtn' className='bg-[#004450] px-6 py-4  font-bold text-[white] cursor-pointer hover:bg-white hover:text-[#004450]' onMouseOver={clickHandler}>Mobile App Development</h4>
      <h4 id='aiBtn' className='bg-[#004450] px-6 py-4  font-bold text-[white] cursor-pointer hover:bg-white hover:text-[#004450]' onMouseOver={clickHandler}>Artificial Intelligence</h4>

...
const ProductDevelpment = () => {
  return (
    <div className='md:flex bg-[#DAF3F4] md:h-[90vh] w-full md:px-32 px-8 py-6 md:py-0 justify-center items-center gap-8'>
    <div className='w-[50%]'>
    ...
    <button className='text-[#004450]'>Explore More</button>
    </div>

...
const StoriesToProductSection = () => {
  return (
    ...
    <div className='md:w-[50%]'>
        ...
        <h2>We are all about converting user journeys to product.</h2>
        ...
        <hr className="w-48 h-1 mx-auto my-4 bg-gray-100 border-0 rounded md:my-10 dark:bg-gray-700"/>
            ...
            <div className='inline-flex  items-center gap-2 w-[50%]'><span><IoCheckmarkCircleOutline/></span><span className='text-xl font-medium'>Cloud and Devops</span></div>

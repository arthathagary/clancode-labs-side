...
const GetStartedSection = () => {
  ...
  return (
    ...
    <motion.button
     ...
     onRelease={() => setIsPressed(false)} className='self-center bg-[#45C1CE] px-6 py-4 rounded-full font-bold text-xl text-[#004450] hover:bg-[#3a9fa8]'>Get Started Now</motion.button>
    </div>
  )
}

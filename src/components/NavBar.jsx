...
const NavBar = () => {
   ...
   */}
        ...
        <div
          className=" lg:hidden z-50 block cursor-pointer "
        ...
        <div
          className={
            nav
              ? " lg:hidden text-black  absolute top-0 right-0 bottom-0 left-0 flex justify-center items-center w-full h-screen bg-black  text-center ease-in-out duration-500"
              : "lg:hidden  absolute top-0 right-0 bottom-0 left-[-100%] flex justify-center items-center w-full h-screen bg-slate-500  text-center ease-in-out duration-500 "
          }
        >
